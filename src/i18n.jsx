...
export const STR = {
  ko: {
    ...
    shareModalHint: "지금 설정한 링크·타이밍을 올려요",
    shareFlips: (n) => `넘김 ${n}개`,
    shareLinkOk: "링크 연결됨",
    shareLinkNone: "링크 없음",
    ...
    // ①②③ — 번호는 스텝 레일 원형 배지가 보여주므로 라벨엔 넣지 않는다
    step1: "유튜브 반주 링크",
    urlPlaceholder: "https://youtu.be/... 또는 watch?v=...",
    step2: "악보 파일",
    step2Hint: "없으면 영상만 크게 나와요",
    pdfPick: "PDF 불러오기",
  ...
  en: {
    ...
    shareModalHint: "Publish the link and timing you've set up",
    shareFlips: (n) => `${n} turns`,
    shareLinkOk: "Link attached",
    shareLinkNone: "No link",
    ...
    step2: "Score PDF",
    step2Hint: "optional — video only if skipped",
    pdfPick: "Open PDF",
    ...
    cueTitle: "Page-turn timing",
    tuneEnter: "Tap while listening",
    tuneEnterTitle:
